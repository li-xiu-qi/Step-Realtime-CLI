...
const zh = {
  ...
  'tasksViewer.filterRunning': '运行中',
  'tasksViewer.filterCompleted': '已完成',
  'tasksViewer.filterFailed': '失败/终止',
  'tasksViewer.empty': '暂无后台任务。后台 bash / 子 agent / workflow 会出现在这里。',
  'tasksViewer.tailTitle': '输出预览（{id}）',
  'tasksViewer.noOutput': '（暂无输出）',
  'tasksViewer.detailTitle': '详情',
  'tasksViewer.detail.id': '任务 ID',
  'tasksViewer.detail.status': '状态',
  'tasksViewer.detail.kind': '类别',
  'tasksViewer.detail.agentType': 'Agent 类型',
  'tasksViewer.detail.description': '描述',
  'tasksViewer.detail.time': '时间',
  'tasksViewer.detail.exitCode': '退出码',
  'tasksViewer.detail.duration': '时长',
  'tasksViewer.kind.process': '进程',
  'tasksViewer.kind.subagent': '子agent',
  'tasksViewer.kind.workflow': 'workflow',
  'tasksViewer.timeRunning': '已运行 {rel}',
  'tasksViewer.timeFinished': '{rel} 前结束',
  'tasksViewer.footer': '↑↓/jk 选择 · Enter/o 输出 · s 停止 · r 刷新 · Tab 过滤 · q/Esc 关闭',
  'tasksViewer.confirmStop': '确认停止 {id}？（y 确认 / n 取消）',
  'tasksViewer.alreadyTerminal': '{id} 已是终态（{status}），无法停止。',
  'tasksViewer.stopped': '已停止 {id}（其终态通知已抑制）。',
  'tasksViewer.stopFailed': '停止 {id} 失败（可能刚结束）。',
  'tasksViewer.outputTitle': '── 任务输出 {id} · {label} ──',
  ...
  'app.memory.listGlobal': '全局观察（~/.step-code/memory/）：',
  'app.memory.listProject': '项目观察（.step-code/memory/）：',
  'app.memory.listEmpty': '  （暂无）',
  'app.memory.indexUsage': '索引字符用量：{used} / {budget}',
  'app.memory.brokenHeader': '待修复（解析失败的文件）：',
  'app.memory.reviewHint': '提示：观察条目较多或最旧条目超过 30 天——该回顾了：确认成立的晋升到 AGENTS.md / skills，噪声删掉。',
  ...
  // 压缩摘要回放：旧 assistant 输出折叠进了摘要，必须把摘要正文摆出来，否则 resume 后满屏用户消息、看似模型输出丢失
  ...
  'app.provider.added': '已添加渠道 {id}（{count} 个模型别名），写入前已备份原配置。在下方选择器挑一个默认模型（Esc 跳过）。',
  ...
  'providerManager.deleteConfirm': '删除渠道 {id}（含 {count} 个模型别名）？此操作不可恢复 [y/N]',
  ...
  'providerWizard.ask.id': '渠道 id（[providers.<id>] 的名字：小写字母 / 数字 / 中划线 / 下划线）',
  'providerWizard.ask.type': '协议类型（决定请求报文格式）',
  ...
  'providerWizard.ask.baseUrl': 'base_url（渠道 API 端点）',
  ...
  'providerWizard.ask.apiKey': 'API key（将明文写入 config.toml）',
  'providerWizard.ask.apiKeyEnv': '环境变量名（如 MY_GW_API_KEY）',
  'providerWizard.ask.modelId': '首个模型的真实 id',
  'providerWizard.ask.displayName': '显示名（选择器与状态栏展示用，可留空）',
  'providerWizard.ask.maxContext': '上下文窗口 token 数（可留空，继承顶层默认）',
  ...
  'providerWizard.err.idExists': '渠道 id 已存在，请换一个',
  ...
  'providerWizard.hint.select': '↑↓ 移动 · Enter 确认 · Esc 取消',
  ...
  'firstRun.providerLabel': '接入方式：{label}',
  'firstRun.confirmTitle': '确认配置',
  'firstRun.confirmProvider': '渠道：{label}',
  'firstRun.confirmBaseUrl': '端点：{url}',
  'firstRun.confirmKeyHint': 'API key：已填写（不显示）',
  'firstRun.confirmModel': '默认模型：{name}（别名 {alias}）',
  'firstRun.confirmHint': 'Enter 确认写入 · Esc 返回修改',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'tasksViewer.filterCompleted': 'completed',
  'tasksViewer.filterFailed': 'failed/killed',
  'tasksViewer.empty': 'No background tasks. Background bash / subagents / workflows will show up here.',
  'tasksViewer.tailTitle': 'Preview output ({id})',
  'tasksViewer.noOutput': '(no output yet)',
  'tasksViewer.detailTitle': 'Detail',
  'tasksViewer.detail.id': 'Task ID',
  'tasksViewer.detail.status': 'Status',
  'tasksViewer.detail.kind': 'Kind',
  'tasksViewer.detail.agentType': 'Agent type',
  'tasksViewer.detail.description': 'Description',
  'tasksViewer.detail.time': 'Time',
  'tasksViewer.detail.exitCode': 'Exit code',
  'tasksViewer.detail.duration': 'Duration',
  'tasksViewer.kind.process': 'process',
  'tasksViewer.kind.subagent': 'subagent',
  'tasksViewer.kind.workflow': 'workflow',
  'tasksViewer.timeRunning': 'running for {rel}',
  'tasksViewer.timeFinished': 'finished {rel} ago',
  'tasksViewer.footer': '↑↓/jk select · Enter/o output · s stop · r refresh · Tab filter · q/Esc close',
  'tasksViewer.confirmStop': 'Stop {id}? (y confirm / n cancel)',
  'tasksViewer.alreadyTerminal': '{id} is already terminal ({status}); cannot stop.',
  'tasksViewer.stopped': 'Stopped {id} (its settle notification suppressed).',
  'tasksViewer.stopFailed': 'Failed to stop {id} (may have just finished).',
  'tasksViewer.outputTitle': '── Task output {id} · {label} ──',
  ...
  'app.memory.listGlobal': 'Global observations (~/.step-code/memory/):',
  'app.memory.listProject': 'Project observations (.step-code/memory/):',
  'app.memory.listEmpty': '  (none)',
  'app.memory.indexUsage': 'Index usage: {used} / {budget} chars',
  'app.memory.brokenHeader': 'Needs repair (files that failed to parse):',
  'app.memory.reviewHint': 'Hint: many observations or the oldest is over 30 days old — time to review: promote confirmed ones into AGENTS.md / skills, delete the noise.',
  ...
  'app.provider.added': 'Channel {id} added ({count} model aliases); the previous config was backed up first. Pick a default model in the picker below (Esc to skip).',
  ...
  // --- /provider 渠道管理面板（ProviderManager）---
  'providerManager.title': 'Provider Channels',
  'providerManager.hint': '↑↓ move · Enter switch · A add · D delete · Esc close',
  ...
  'providerManager.deleteConfirm': 'Delete channel {id} (with {count} model alias(es))? This cannot be undone [y/N]',
  ...
  'providerWizard.ask.displayName': 'Display name (used by pickers and the status bar; may be empty)',
  ...
  'providerWizard.err.idExists': 'Channel id already exists; pick another',
  ...
  'app.team.statusBody': 'Base branch: {base}\nState dir: {dir}\nMissions:\n{body}',
  ...
  'firstRun.providerLabel': 'Method: {label}',
  'firstRun.confirmTitle': 'Confirm Configuration',
  'firstRun.confirmProvider': 'Provider: {label}',
  'firstRun.confirmBaseUrl': 'Endpoint: {url}',
  'firstRun.confirmKeyHint': 'API key: filled (hidden)',
  'firstRun.confirmModel': 'Default model: {name} (alias {alias})',
  'firstRun.confirmHint': 'Enter to confirm · Esc to go back',
